...
public class BotTest
{
    ...
    public void canBotFindWinningMoveDiagonal()
    {
        ...
        gameState.updateGameWithString(boardTest2);
        ...
        Assert.assertEquals('O', gameState.getBoard().getPebble(1,2));
    }
}
